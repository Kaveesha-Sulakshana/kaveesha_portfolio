...
export const AboutMe = () => {
  return <section className="py-16 md:py-24">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mt-8">
          <a href="/KAVEESHA SULAKSHANA Resume.pdf" download className="inline-flex items-center px-6 py-3 bg-[#6EC6B0]/20 text-[#6EC6B0] rounded-lg hover:bg-[#6EC6B0]/30 transition-all duration-300 transform hover:scale-105">
